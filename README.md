...
This project is an MCP (Multi-Agent Conversation Protocol) Server for the given OpenAPI URL - https://api.apis.guru/v2/specs/nexmo.com/redact/1.0.6/openapi.json, auto-generated using AG2's [MCP builder](https://mcp.ag2.ai).
